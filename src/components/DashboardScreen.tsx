      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 py-20">
        ...
        >
          <motion.button
            ...
            className="relative overflow-hidden px-8 py-4 rounded-xl font-semibold text-white text-base tracking-normal transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl cursor-pointer bg-gray-900"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
          >
            {/* Minimal shimmer effect - subtle and elegant */}
            <div className="absolute inset-0 rounded-xl opacity-10 bg-white"></div>

            {/* Clean, minimal button text */}
            <span className="relative z-10">💭 Log Today's Emotion</span>
          </motion.button>
