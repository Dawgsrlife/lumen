              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Stay updated with your wellness journey</p>
                  </div>
                </div>
                <button
                  onClick={onClose}
            ...
            <div className="max-h-[60vh] overflow-y-auto">
              {notifications.length === 0 ? (
                <div className="px-6 py-12 text-center">
                  ...
                  <p className="text-gray-500">We'll notify you about important updates and insights</p>
                </div>
              ) : (
                  ...
                  {notifications.map((notification) => (
                    ...
                    >
                      <div className="flex items-start space-x-3">
                        <div className={`w-3 h-3 rounded-full mt-2 flex-shrink-0 ${getNotificationColor(notification.type)}`}></div>
