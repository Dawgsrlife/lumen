...
const WelcomePage: React.FC = () => {
  ...
  const handleWelcomeComplete = async () => {
    console.log('WelcomePage: Welcome screen completed, checking daily status...');
    ...
    try {
      ...
      if (hasLoggedToday) {
        console.log('WelcomePage: User has logged today, redirecting to dashboard');
        navigate('/dashboard');
      } else {
        console.log('WelcomePage: User has not logged today, redirecting to flow');
        navigate('/flow');
      }
    } catch (error) {
